...
import styles from "../styles/Ollainville.module.css";
import LeafPopup from "./popupInfo/LeafPopup";
import Link from "next/link";

function OllainvilleHouse() {

  const images = {
    off: "/OH_WIDESCREEN_OFF.jpg",
    on: "/OH_WIDESCREEN_ON.jpg",
  };
...
export default OllainvilleHouse;
