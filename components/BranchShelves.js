...
import styles from "../styles/BranchShelves.module.css";
import LeafPopup from "./popupInfo/LeafPopup";
import Link from "next/link";

function BranchShelves() {
  const images = {
    off: "/BS_WIDESCREEN_OFF.jpg",
    on: "/BS_WIDESCREEN_ON.jpg",
  };
  ...
  BranchShelves.category = "objects";
