...
import styles from "../styles/InnermostHouseInfo.module.css";

const InnermostHouseInfo = () => {
  return (
    <div className={styles.container}>
      <div className={styles.infoContainer}>
        <h1 className={styles.infoTitle}>Innermost House</h1>
...
export default InnermostHouseInfo;
